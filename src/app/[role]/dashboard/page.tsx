...
console.log("user",user)  
  ...
  // Handle date range change and fetch
  ...
  // Static stats data transformed with dynamic values
  const statsData = {
    courses: {
      total: dynamicStats?.total_products || 0,
      active: 8,
      upcoming: 2
    },
    lessons: {
      total: dynamicStats?.total_domains || 0,
      active: 45,
      upcoming: 12
    },
    enrollments: {
      total: dynamicStats?.total_users || 0,
      passed: 120,
      new: 15
    },
    students: {
      total: dynamicStats?.total_clients || 0,
      active: 85,
      new: 10
    }
  }
