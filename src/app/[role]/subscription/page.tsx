...
const navigationTabs = getNavigationByRole(user?.role)
  ...
  // Edit fields configuration for inline editing
  const editFields = [
    { name: 'product_name', label: 'Product', type: 'text' as const, required: true, className: 'min-w-[180px]' },
    { name: 'renewal_date', label: 'Renewal Date', type: 'date' as const, required: true, className: 'min-w-[140px]' },
    { name: 'amount', label: 'Amount', type: 'number' as const, required: true, className: 'min-w-[120px]' },
    { name: 'expiry_date', label: 'Expiry Date', type: 'date' as const, required: true, className: 'min-w-[140px]' },
