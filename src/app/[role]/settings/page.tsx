...
export default function SettingsPage() {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setProfileData((prev) => ({
          ...
          d_passwork: data.password,
          currentPassword: data.d_password,
        }));
  ...
  return (
    <div className="min-h-screen pb-8">
      <Header title="Settings" tabs={navigationTabs} />
                ...
                <GlassCard className="p-6">
                  ...
                  <div className="flex items-center gap-6 mb-6">
                    <div className="relative">
                      <div className="w-20 h-20 rounded-full bg-[rgba(255,255,255,var(--ui-opacity-10))] flex items-center justify-center overflow-hidden">
                        {profileData.profile ? (
                          <img
                            src={
                              profileData.profile.startsWith("blob:")
                                ? profileData.profile
                                : `${ASSETS_URL}/${profileData.profile}`
                            }
                            alt="Profile"
                      ...
                      <button
                        ...
                        className="absolute -bottom-1 -right-1 p-2 rounded-full glass-button"
                      >
                    ...
                    <div>
                      ...
                      <p className="text-[var(--text-muted)] text-sm">{user?.role}</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                      <div>
                        <label className="block text-theme text-sm mb-2">
                          Full Name
                        </label>
                        <GlassInput
